...
namespace HomeWork.ViewModel
{
    ...
    public partial class MainViewModel : Bindable
    {
        ...
        public MainViewModel(IMediator sender, IMapper mapper)
        {
            _sender = sender;
            _mapper = mapper;
            ...
            GetClients = new RelayCommand(OnGetClients, CanGetClients);
            UpdateClients = new RelayCommand(OnUpdateClients, CanUpdateClients);
        ...
        public ICommand GetClients { get; }
        public ICommand UpdateClients { get; }
